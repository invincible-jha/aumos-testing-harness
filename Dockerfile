# ============================================================================
# Dockerfile — aumos-testing-harness
# Multi-stage Python 3.11-slim build with non-root aumos user
# ============================================================================
...
# Start service
CMD ["uvicorn", "aumos_testing_harness.main:app", "--host", "0.0.0.0", "--port", "8000", "--workers", "1"]
